...
const allProductsHaveReviews = (products) => {
    return products.every(product => product.reviews && product.reviews.length > 0);
};
console.log("Todos os produtos têm avaliações:", allProductsHaveReviews(inventory));