...
const filterElectronicsUnder1000 = (products) => {
    return products.filter(product => product.category === "Eletrônicos" && product.price < 1000);
};
console.log("Produtos Eletrônicos abaixo de R$1000:", filterElectronicsUnder1000(inventory));