...
const findFirstClothingProduct = (products) => {
    return products.find(product => product.category === "Vestuário");
};

console.log("Primeiro produto da categoria 'Vestuário':", findFirstClothingProduct(inventory));